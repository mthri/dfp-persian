...
<p align="center">
  ...
  ما باید یک منطق اساسی به الگویمان اضافه کنیم تا زمانی که آن جلد وجود نداشت به جستجوی آن نپردازد! و با یک جمله شرطی (if) که book.cover را چک می‌کند و اگر موجود باشد آن را نمایش می‌دهد.
<div dir='ltr'>
