...
در این فصل نحوه آپلود فایل های کاربر را یاد گرفتیم. در عمل ساده میباشد اما ولی نگرانی های لایه امنیتی نیاز به تمرکز دارد.

در فصل بعد مجوزهایی را برای قفل کردن سایت خود اضافه می کنیم.
