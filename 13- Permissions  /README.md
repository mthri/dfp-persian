...
حال اگر از سیستم خارج شده و برروی لینک Books کلیک کنید به صفحه ی ورود به سیستم هدایت می شود در حالی که اگروارد سیستم شده باشد با کلیک روی لینک فوق لیست کتاب ها نمایش داده می شوند .
